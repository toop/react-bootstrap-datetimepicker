	...
	var DateTimeField = (function (_Component) {
	  ...
	  function DateTimeField() {
	    ...
	    this.resolvePropsInputFormat = function () {
	      ...
	      switch (_this.props.mode) {
	        case _ConstantsJs2["default"].MODE_TIME:
	          return _moment2["default"].localeData(_this.props.locale).longDateFormat('LT');
	        case _ConstantsJs2["default"].MODE_DATE:
	          return _moment2["default"].localeData(_this.props.locale).longDateFormat('L');
	        default:
	          return _moment2["default"].localeData(_this.props.locale).longDateFormat('L') + ' ' + _moment2["default"].localeData(_this.props.locale).longDateFormat('LT');
	      }
	    };
	    ...
	    this.state = {
	      ...
	      viewDate: (0, _moment2["default"])(this.props.dateTime, this.props.format, true).startOf("month").locale(this.props.locale),
	    ...
	    this.componentWillReceiveProps = function (nextProps) {
	      ...
	      if (nextProps.dateTime !== _this.props.dateTime && (0, _moment2["default"])(nextProps.dateTime, nextProps.format, true).isValid()) {
	        state.viewDate = (0, _moment2["default"])(nextProps.dateTime, nextProps.format, true).startOf("month").locale(_this.props.locale);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DateTimePickerDays = (function (_Component) {
	  ...
	  _createClass(DateTimePickerDays, [{
	    key: "renderDaysCaption",
	    value: function renderDaysCaption() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DateTimePickerTime = (function (_Component) {
	              ...
	              _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                  ...
	                  _react2["default"].createElement(
	                    ...
	                    _this.props.selectedDate.format(_this.getHoursFormat())
	                  )
	                ),
	                _react2["default"].createElement(
	                  "td",
	                ...
	                _react2["default"].createElement(
	                  ...
	                  _react2["default"].createElement(
	                    ...
	                    _this.props.selectedDate.format(_this.getMinutesFormat())
	                  )
	                ),
	                _react2["default"].createElement("td", { className: "separator" }),
	                _this.renderPeriodBtn()
	              ),
	              _react2["default"].createElement(
	                "tr",
	                null,
	  ...
	  _createClass(DateTimePickerTime, [{
	    key: "renderPeriodBtn",
	    value: function renderPeriodBtn() {
	    ...
	    value: function getTimeFormat() {
	      return _moment2["default"].localeData(this.props.locale).longDateFormat('LT');
	    }
	  }, {
	    key: "render",
	    value: function render() {
